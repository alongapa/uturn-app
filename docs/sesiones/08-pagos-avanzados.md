...
5. **Pagar con créditos**: opción de cubrir parte del viaje con créditos Uturn (tasa de conversión configurable por el owner), integrando el saldo de la Sesión 2.
...
4. Liquidaciones: pantalla "Mis ganancias" del conductor (bruto, comisión Uturn, neto, historial).
