      ...
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.starsRow}>
            {STARS.map((value) => (<TouchableOpacity key={value} onPress={() => setScore(value)}>
                <Text style={[styles.star, value <= score && styles.starActive]}>★</Text>
              </TouchableOpacity>))}
          </View>
          <Text style={styles.scoreText}>{score} / 5</Text>
          <TextInput style={styles.textArea} placeholder="Comentarios adicionales" placeholderTextColor="#94a3b8" multiline numberOfLines={4} value={comment} onChangeText={setComment}/>
