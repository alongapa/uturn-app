...
export default function LoginScreen() {
    ...
    const handleLogin = useCallback(() => {
        ...
        const homeCampusId = (_a = CAMPUSES.find((campus) => campus.universityId === universityId)) === null || _a === void 0 ? void 0 : _a.id;
    ...
    return (<View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <TextInput style={styles.input} placeholder="nombre@alumnos.uai.cl" keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail}/>

        <Text style={styles.label}>Fecha de nacimiento (AAAA-MM-DD)</Text>
        <TextInput style={styles.input} placeholder="1999-08-15" autoCapitalize="none" value={dateOfBirth} onChangeText={setDateOfBirth}/>
      </View>
