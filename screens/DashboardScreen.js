...
const getDashboardStatusBackground = (status) => {
    ...
    return (<SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {BOOKINGS_SUMMARY.map((booking) => (<View key={booking.id} style={styles.bookingCard}>
              <View>
        ...
        <View style={styles.section}>
          ...
          {DRIVER_SPOTLIGHT.map((driver) => {
            var _a;
            return (<View key={driver.id} style={styles.driverRow}>
              <View>
                <Text style={styles.driverName}>{driver.name}</Text>
                <Text style={styles.driverMeta}>{driver.car}</Text>
              </View>
              <Text style={styles.driverScore}>{(_a = driver.rating) === null || _a === void 0 ? void 0 : _a.toFixed(1)} ★</Text>
            </View>);
        })}
        </View>
      </ScrollView>
