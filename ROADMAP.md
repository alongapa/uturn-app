...
| Calidad y lanzamiento | 🟡 Sesión 10 | Hecho: Jest + RNTL (149 tests sobre penalizaciones, comisiones, créditos, matching, k-anonimato, filtrado de PII y documentos legales); CI en GitHub Actions; eas.json con dev/preview/prod + EAS Update; onboarding de primer uso con aceptación obligatoria de las reglas de pago antes de la primera reserva; permisos de ubicación/push pedidos en contexto; Sentry solo para crashes y sin datos personales; ícono y splash rehechos para Unities (el anterior seguía dibujando "UT"); política de privacidad y términos que cubren Fintoc y la analítica; feature flags en Supabase; FlashList en el feed. **Pendiente**: correr los flujos de Maestro en verde, build de iOS (necesita credenciales de Apple), FlashList en chat/mensajes, screenshots y fichas de tienda |
